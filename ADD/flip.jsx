...
import backgroundImage from './pimentel_bg.JPG';
...
const Flipbook = () => {
  ...
  return (
    <div className="flipbook-container" style={{ backgroundImage: `url(${backgroundImage})`, backgroundSize: 'cover' }}>
     
      <FlipPage width={400} height={708}>
                      ...
                      <div>
                        ...
                        <ul id="ul-flip">
                          {user.education.map((item, eduIndex) => (
                            <li id="li-flip" key={eduIndex}>{item}</li>
                          ))}
                        </ul>
                      </div>
                    </div>
